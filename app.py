    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            "glistering_melon_slice"
                ...
                # Stream the zip file directly from memory instead of saving it to /tmp
                ...
                return send_file(zip_buffer, as_attachment=True, download_name="Converted_Texture_Pack.zip", mimetype='application/zip')
